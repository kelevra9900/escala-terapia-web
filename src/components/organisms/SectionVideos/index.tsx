...
const SectionVideos: FC<SectionVideosProps> = ({videos = demo_videos,className = ''}) => {
	...
	return (
		<div className={`nc-SectionVideos ${className}`}>
			<Heading desc="Tutoriales breves para terapeutas: crea formularios clínicos, automatiza escalas, interpreta resultados y mantén la privacidad de tus pacientes. Descubre cómo optimizar tu trabajo sin complicaciones.">
				🎥 Videos para terapeutas
			</Heading>
