		...
		<footer className="border-t border-neutral-200 dark:border-neutral-700">
			<div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
						...
						<div className="flex gap-x-6">
							{navigation.social.map((item) => (
								<a
									key={item.name}
									href={item.href}
									className="text-gray-600 hover:text-gray-800 dark:text-neutral-400 font-(family-name:--font-inter)"
								>
					...
					<div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
						<div className="md:grid md:grid-cols-2 md:gap-8">
							<div>
								<h3 className="text-sm/6 font-semibold text-gray-900 dark:text-neutral-300 font-(family-name:--font-inter)">
									Soluciones
								</h3>
								<ul role="list" className="mt-6 space-y-4">
									{navigation.solutions.map((item) => (
										<li key={item.name}>
											<a
												href={item.href}
												className="text-sm/6 text-gray-600 hover:text-gray-900 dark:text-neutral-400 font-(family-name:--font-inter)"
											>
												{item.name}
											</a>
										</li>
				...
				<div className="mt-16 border-t border-gray-900/10 pt-8 dark:border-gray-700 sm:mt-20 lg:mt-24">
					<p className="text-sm/6 text-gray-600 dark:text-neutral-400 font-(family-name:--font-inter)">
